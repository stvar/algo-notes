...
%
\begin{align*}
& E_{n+1}\lp s A\mc e\rp \eqbyref{defEn} E_n\lp s A\mc e\rp\mc
...
%
\begin{align*}
& E_{n+1}\lp s A\mc e\rp \eqbyref{defEn} E_n\lp s A\mc e\rp A\mc
  L_{n+1}\lp e\rp \eqbyref{defLn} L_n\lp e'\rp + \neg e_{n+1} = L_n\lp e'\rp \\
& \implbyref{defvalid} E_n\lp s\mc e'\rp \txt{does not contain} B\txt{s}
  \implbyref{minle} l \ge \sharp\lp s\mc B\rp
\end{align*}
%
Consequently:
\begin{align*}
